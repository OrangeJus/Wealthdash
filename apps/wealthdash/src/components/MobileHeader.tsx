...
const MobileHeader = ({ onOpenTransaction }: MobileHeaderProps) => {
  return (
    <header className="md:hidden flex justify-between items-center px-margin-mobile h-[56px] w-full z-40 bg-surface border-b border-outline-variant sticky top-0 shrink-0">
      ...
      <button 
        ...
        className="bg-secondary text-on-secondary px-3 py-1.5 rounded-lg font-label-caps text-label-caps flex items-center gap-1 shadow-sm active:scale-95 transition-transform"
      >
